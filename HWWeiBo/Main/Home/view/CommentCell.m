...
- (void)awakeFromNib {
    ...
    _nameLabel.colorName=@"Timeline_Name_color";
...
-(void)themeChangeAction:(NSNotification *)no
{
    
    _commentTextLabel.textColor=[[ThemeManager shareInstance]getThemeColor:@"Timeline_Content_color"];
...
- (void)layoutSubviews{
    ...
    _commentTextLabel.frame = CGRectMake(_imgView.right+10, _nameLabel.bottom+5,280, height);
