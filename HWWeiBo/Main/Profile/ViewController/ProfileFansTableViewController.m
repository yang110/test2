//
//  ProfileFansTableViewController.m
//  HWWeiBo
//
...
@interface ProfileFansTableViewController ()
{
...
@implementation ProfileFansTableViewController
...
-(void)loadData
{
    ...
    [DataService requestAFUrl:@"/2/friendships/followers.json" httpMethod:@"GET" params:params datas:nil block:^(id result) {
